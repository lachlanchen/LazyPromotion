...
Want one short clip rather than subtitles for the whole recording? I offer a [USD 250 Story Clip Pilot](https://lazying.art/story-clip/?utm_source=lazyblog&utm_medium=article&utm_campaign=story_clip_pilot&utm_content=cantonese_caption_delivery#sample): two timestamped candidates from a recording you own, up to 30 minutes, then the one you choose becomes a vertical clip of up to 60 seconds with source-language captions and an editable SRT. Start with the sample and free fit check; we agree the scope before you send the recording.
