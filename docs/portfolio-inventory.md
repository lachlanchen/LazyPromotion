...
The first-USD-1,000 route is confirmed payments totalling USD 1,000 across seven bounded services: Local Knowledge Terminal collection-fit, Manuscript Build & Redline, the Bilingual Lecture Pack, the Story Clip Pilot, the Book Specimen Sprint, AI Clip Assembly, and the OpenHI software reproducibility sprint. The eInk inquiry and Figurine checkout remain separate offers, not competing calls to action. Open-source replies should optimize for a solved problem, not for extracting a donation. GitHub Sponsors and donations remain quiet secondary support routes on the project/profile pages.
