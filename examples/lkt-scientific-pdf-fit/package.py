#!/usr/bin/env python3
"""Build the deterministic public LKT scientific-PDF sample packet."""
...
OUTPUT = ARTIFACTS / "lkt-scientific-pdf-fit-sample.zip"
CHECKSUM = ARTIFACTS / "lkt-scientific-pdf-fit-sample.zip.sha256"
ARCHIVE_ROOT = "lkt-scientific-pdf-fit-sample"
...
SOURCE_FILES = (
    ...
    "collection.json",
    "questions.json",
    "source/paper-a-v1.tex",
    "source/paper-a-v2.tex",
    "source/paper-b-multilingual.tex",
)
ARTIFACT_FILES = (
    "browser-card.html",
    "citation-check.json",
