...
يحافظ المستودع أيضًا على فهرس عام لـ 109 مستودعات مصدر غير مؤرشفة، ويحوّل البرمجيات والكتب والرسوم المعرفية والبحث والوسائط وتعلّم اللغات والذكاء الاصطناعي المحلي إلى فرص محددة للمشتري ومقيّدة بالدليل. يدعم مسار مراجعة MCP الأساسي بسعر 500 دولار وتسع خدمات مجاورة ثابتة النطاق هدف أول 1000 دولار موثّقة؛ ولا تُحسب النقرات أو النجوم أو الطلبات أو المنشورات المجدولة إيرادًا.
...
| [`app_preview.py`](../app_preview.py) و[`apps/`](../apps/README.md) | سجل محلي على الويب/PWA ومسودات حملات قابلة للتحرير مع حفظ وتصدير صريحين؛ شغّل `python3 app_preview.py`. لا تزال معاينتا Android وSwiftUI تستخدمان نسخة عامة مؤرخة. نجح بناء Android؛ لم يُتحقق من بناء iOS بعد. لا يوجد نشر تلقائي حتى الآن. |
