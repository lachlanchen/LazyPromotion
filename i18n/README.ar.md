...
يستخدم الإعداد الافتراضي شاشة واحدة بحجم 3840×1080 (`:116`) وممرين مستقلين لمتصفح Chrome بحجم 1920×1080 يشتركان في ملف شخصي دائم واحد. يعرض noVNC ممر الحملات على `6138` وممر الشركاء على `6137` والعرض الكامل على `6136`، بينما يبقى CDP على `127.0.0.1:9436` والجلسة `lazypromotion-browser`. ترتبط الخدمات بالواجهة المحلية فقط، ويرفض المشغل المنافذ المجهولة المشغولة ولا يزيل إلا قفل شاشة قديم يثبت أنه يخصه.
