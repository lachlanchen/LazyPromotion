...
La configuration par défaut utilise l’écran `:116`, VNC `127.0.0.1:5936`, noVNC `127.0.0.1:6136`, CDP `127.0.0.1:9436` et la session `lazypromotion-browser`. Tous les services restent sur loopback. Le lanceur refuse les ports occupés inconnus et ne nettoie qu’un verrou obsolète qui lui appartient.
