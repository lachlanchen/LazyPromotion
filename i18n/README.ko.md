...
기본값은 디스플레이 `:116`, VNC `127.0.0.1:5936`, noVNC `127.0.0.1:6136`, CDP `127.0.0.1:9436`, 세션 `lazypromotion-browser`입니다. 모든 서비스는 루프백에만 바인딩되며, 알 수 없는 사용 중 포트를 거부하고 자체 기록으로 오래된 것이 확인된 디스플레이 잠금만 정리합니다.
