...
| [`app_preview.py`](../app_preview.py) и [`apps/`](../apps/README.md) | Локальный веб/PWA-просмотр выбранных публичных кампаний только для чтения с сохранением офлайн-копий по явному действию; запуск: `python3 app_preview.py`. Нативные клиенты и автоматическая публикация в этой версии не реализованы. |
