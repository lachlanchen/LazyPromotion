...
| [`app_preview.py`](../app_preview.py) 和 [`apps/`](../apps/README.md) | 本地只读 Web/PWA 预览；运行 `python3 app_preview.py`。Android 和 SwiftUI 原生预览共享带日期的公开数据快照。Android 已编译通过，iOS 编译尚未验证。暂不支持自动发布。 |
