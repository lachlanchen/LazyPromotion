...
| [`app_preview.py`](../app_preview.py) 和 [`apps/`](../apps/README.md) | 本機唯讀 Web/PWA 預覽；執行 `python3 app_preview.py`。Android 和 SwiftUI 原生預覽共用帶日期的公開資料快照。Android 已編譯通過，iOS 編譯尚未驗證。暫不支援自動發布。 |
